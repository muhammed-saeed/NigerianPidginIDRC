...
with open("/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/ProjectedDataSet/discontinous/textfiles/simalignRoberta/DiscontinousImpEntrelenglish.txt", "w") as fb:
    fb.writelines(english_fullRawtext)
with open("/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/ProjectedDataSet/discontinous/textfiles/simalignRoberta/DiscontinousImpEntrelpidgin.txt", "w") as fb:
...
with tqdm(total=total_sentences, desc="Aligning sentences") as pbar:
    for pcm_sent, english_sent in zip(pidgin_fullRawtext, english_fullRawtext):
        ...
        pbar.update(1)  
with open("/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/ProjectedDataSet/discontinous/textfiles/simalignRoberta/filtered_alignmentsEN2PCM.txt", "w", encoding="utf-8") as f:
