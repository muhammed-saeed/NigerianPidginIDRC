...
with open('/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/ProjectedDataSet/discontinous/textfiles/simalignRoberta/DiscontinousImpEntrelenglish.txt', 'r') as f:
    english_texts = f.readlines()
with open("/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/ProjectedDataSet/discontinous/textfiles/simalignRoberta/DiscontinousImpEntrelpidgin.txt", "r") as f:
    pcm_texts = f.readlines()
with open("/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/ProjectedDataSet/discontinous/textfiles/simalignRoberta/filtered_alignmentsPCM2EN.txt", "r") as f:
...
folder_path = f'/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/discontinous/projectedFiles/simalignRoberta/{current_date}'
...
combined_path = f'/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/discontinous/projectedFiles/simalignRoberta/{current_date}/combined'
