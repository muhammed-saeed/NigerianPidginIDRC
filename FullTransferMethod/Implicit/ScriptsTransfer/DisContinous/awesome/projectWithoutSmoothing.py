...
with open('/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/ProjectedDataSet/discontinous/textfiles/awesome/englishBERTAlignment/EnglishBERTDiscontinousImpEntrelenglish.txt', 'r') as f:
    english_texts = f.readlines()
with open("/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/ProjectedDataSet/discontinous/textfiles/awesome/englishBERTAlignment/EnglishBERTDiscontinousImpEntrelpidgin.txt", "r") as f:
    pcm_texts = f.readlines()
with open("/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/ProjectedDataSet/discontinous/textfiles/awesome/englishBERTAlignment/EnglishBERTfiltered_alignmentsPCM2EN.txt", "r") as f:
...
folder_path = f'/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/discontinous/projectedFiles/awesome/EnglishBERT/{current_date}'
...
combined_path = f'/PATH_TO/NPIDRC/FullTransferMethod/Implicit/dataset/discontinous/projectedFiles/awesome/EnglishBERT/{current_date}/combined'
