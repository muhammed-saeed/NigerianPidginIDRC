...
def main(
    ...
    for item in tqdm(data[:30], desc="Processing data", unit="item"):
        ...
        if instruction == "translate English to Nigerian Pidgin" :
            ...
            predict_pcm_results.append(
                f"Instruction: {instruction}, Input: {input_text}, Output: {output}"
            )
    ...
    save_to_file(results, results_output_file)
