...
with open('align/simAlgin/twiceTEst/english.txt', 'r') as f:
    english_texts = f.readlines()
with open('align/simAlgin/twiceTEst/pcm.txt', 'r') as f:
    pcm_texts = f.readlines()
with open('align/simAlgin/data/simAlign_alignments_outputRobertaPCM.txt', 'r') as f:
...
folder_path = f'align/simAlgin/data/TextErrorPCMRoBERTA/{current_date}'
...
combined_path = f'align/simAlgin/data/TextErrorPCMRoBERTA/{current_date}/combined'
