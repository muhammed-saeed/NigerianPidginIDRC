...
with open('align/awesomealign/rawData/english2pcmAlignment.txt', 'r') as f:
...
folder_path = f'align/awesomealign/data/mBERTmodel/TextError/{current_date}'
...
combined_path = f'align/awesomealign/data/mBERTmodel/TextError/{current_date}/combined'
