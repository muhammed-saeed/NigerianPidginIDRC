...
with open('align/simAlgin/data/simAlign_alignments_output.txt', 'r') as f:
...
folder_path = f'align/simAlgin/data/TextError/{current_date}'
...
combined_path = f'align/simAlgin/data/TextError/{current_date}/combined'
