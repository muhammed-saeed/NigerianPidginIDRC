...
--result_file /PATH_TO/DiscoPrompt/results/englishBaselineT5_v_1_1large/DiscoPromptClassification_PDTB2.txt \
--ckpt_file englishBaseT5_v_1_large/DiscoPromptClassification_PDTB2 \
--prompt_lr 0.3 \
--project_root "/PATH_TO/DiscoPrompt" > "/PATH_TO/DiscoPrompt/results/englishBaselineT5_v_1_1large/t5V1_1LargeLog.txt"