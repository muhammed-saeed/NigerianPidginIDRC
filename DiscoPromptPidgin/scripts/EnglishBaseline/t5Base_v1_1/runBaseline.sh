...
--result_file /local/musaeed/DiscoPrompt/results/englishBaselineT5_v_1_1base/DiscoPromptClassification_PDTB2.txt \
--ckpt_file englishBaseT5_v_1_base/DiscoPromptClassification_PDTB2 \
--prompt_lr 0.3 \
--project_root "/local/musaeed/DiscoPrompt" >  "/local/musaeed/DiscoPrompt/results/englishBaselineT5_v_1_1base/t5_v1_1base.log"