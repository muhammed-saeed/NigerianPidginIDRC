...
--result_file /local/musaeed/NPIDRC/FullTransferMethod/Results/DiscoPrompt/Scratch/Awesome/t5_v1_1_large/03LearningRateDiscoPromptClassification_PDTB2Scratch.txt \
--ckpt_file FullTransferCheckpoints/Awesome/Scratch/large/DiscoPromptClassification_PDTB2_03LRScratchAwesome14May \
--prompt_lr 0.3 \
--epoch 1_000_000 \
--percentage 1 \
--project_root "/local/musaeed/DiscoPrompt" > "/local/musaeed/NPIDRC/FullTransferMethod/Results/DiscoPrompt/Scratch/Awesome/t5_v1_1_large/t5V1_1_largeLog_0_3_learningRate_1M_epochs_AwesomeScratch.txt"
