...
--result_file "/PATH_TO/NPIDRC/FullTransferMethod/Results/FullTransfer/Scratch/Awesome/t5_v1_1_base/03LearningRateDiscoPromptClassification_PDTB2Scratch.txt" \
--ckpt_file FullTransferCheckpoints/Awesome/Scratch/base/DiscoPromptClassification_PDTB2_03LRScratchAwesome23May \
--prompt_lr 0.3 \
--epoch 1_000_000 \
--percentage 1 \
--project_root "/PATH_TO/DiscoPrompt" > "/PATH_TO/NPIDRC/FullTransferMethod/Results/FullTransfer/Scratch/Awesome/t5_v1_1_base/t5V1_1_baseLog_0_3_learningRate_1M_epochs_AwesomeScratch.txt"
