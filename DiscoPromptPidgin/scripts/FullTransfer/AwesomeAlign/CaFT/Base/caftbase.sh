...
--result_file "/local/musaeed/NPIDRC/FullTransferMethod/Results/FullTransfer/CaFT/Awesome/t5_v1_1_base/03LearningRateDiscoPromptClassification_PDTB2CaFT.txt" \
--ckpt_file FullTransferCheckpoints/Awesome/CaFT/base/DiscoPromptClassification_PDTB2_03LRCaFTAwesome \
--prompt_lr 0.3 \
--epoch 1_000_000 \
--percentage 1 \
--project_root "/local/musaeed/DiscoPrompt" > "/local/musaeed/NPIDRC/FullTransferMethod/Results/FullTransfer/CaFT/Awesome/t5_v1_1_base/t5V1_1_baseLog_0_3_learningRate_1M_epochs_AwesomeCaFT.txt"
