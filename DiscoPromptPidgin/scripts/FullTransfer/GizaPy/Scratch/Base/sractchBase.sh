...
--result_file /PATH_TO/NPIDRC/FullTransferMethod/Results/DiscoPrompt/Scratch/GizaPy/t5_v1_1_base/03LearningRateDiscoPromptClassification_PDTB2Scratch.txt \
--ckpt_file FullTransferCheckpoints/GizaPy/Scratch/base/t5_v1_1base/DiscoPromptClassification_PDTB2_03LRScratchGizaPy \
--prompt_lr 0.3 \
--epoch 1_000_000 \
--percentage 1 \
--project_root "/PATH_TO/DiscoPrompt" > "/PATH_TO/NPIDRC/FullTransferMethod/Results/DiscoPrompt/Scratch/GizaPy/t5_v1_1_base/t5V1_1_baseLog_0_3_learningRate_1M_epochs_GizaPyScratch.txt"
