...
--result_file /local/musaeed/NPIDRC/FullTransferMethod/Results/DiscoPrompt/AlignOnly/CaFT/PFT/t5_v1_1_large/03LearningRateDiscoPromptClassification_PDTB2CaFTDoubleCheck.txt \
--ckpt_file AlignOnly/PFT/CaFT/large/DiscoPromptClassification_PDTB2_03LRAkramAlignCaFTPFTDoubleCheck \
--prompt_lr 0.3 \
--epoch 1_000_000 \
--percentage 1 \
--project_root "/local/musaeed/DiscoPrompt" > "/local/musaeed/NPIDRC/FullTransferMethod/Results/DiscoPrompt/AlignOnly/CaFT/PFT/t5_v1_1_large/t5V1_1_largeLog_0_3_learningRate_1M_epochs_PFTCaFTDoubleCheck.txt"
