...
--result_file /PATH_TO/NPIDRC/FullTransferMethod/Results/DiscoPrompt/AlignOnly/CaFT/SimAlignRoBERTa/t5_v1_1_large/03LearningRateDiscoPromptClassification_PDTB2CaFT.txt \
--ckpt_file AlignOnly/SimAlignRoBERTa/CaFT/large/DiscoPromptClassification_PDTB2_03LRAlignOnlyCaFTSimAlignRoBERTa \
--prompt_lr 0.3 \
--epoch 1_000_000 \
--percentage 1 \
--project_root "/PATH_TO/DiscoPrompt" > "/PATH_TO/NPIDRC/FullTransferMethod/Results/DiscoPrompt/AlignOnly/CaFT/SimAlignRoBERTa/t5_v1_1_large/t5V1_1_largeLog_0_3_learningRate_1M_epochs_SimAlignRoBERTaCaFT.txt"
