...
--result_file /PATH_TO/NPIDRC/FullTransferMethod/Results/DiscoPrompt/AlignOnly/CaFT/Awesome/t5_v1_1_base/03LearningRateDiscoPromptClassification_PDTB2CaFT.txt \
--ckpt_file AlignOnly/Awesome/CaFT/base/DiscoPromptClassification_PDTB2_03LRAlignOnlyCaFTAwesome \
--prompt_lr 0.3 \
--epoch 1_000_000 \
--percentage 1 \
--project_root "/PATH_TO/DiscoPrompt" > "/PATH_TO/NPIDRC/FullTransferMethod/Results/DiscoPrompt/AlignOnly/CaFT/Awesome/t5_v1_1_base/t5V1_1_baseLog_0_3_learningRate_1M_epochs_AwesomeCaFT.txt"
